...
import (
	...
	"github.com/shranet/mobile/internal/importers/java"
)
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/shranet/mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/shranet/mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
